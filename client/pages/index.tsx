...
const Home: NextPage = () => {
    ...
    return (
        <Layout>
            ...
            <div className="mt-6 flex max-w-4xl flex-wrap items-center justify-around sm:w-full">
                <div className="mt-6 w-96 rounded-xl border p-6 text-left">
                    <Link href="/csr" passHref={true}>
                        <a className="text-2xl font-bold text-blue-600 hover:text-black focus:text-black">CSR</a>
                    </Link>
                </div>
                <div className="mt-6 w-96 rounded-xl border p-6 text-left">
                    <Link href="/ssr" passHref={true}>
                        <a className="text-2xl font-bold text-blue-600 hover:text-black focus:text-black">SSR</a>
                    </Link>
                </div>
                <div className="mt-6 w-96 rounded-xl border p-6 text-left">
                    <Link href="/ssg" passHref={true}>
                        <a className="text-2xl font-bold text-blue-600 hover:text-black focus:text-black">SSG</a>
                    </Link>
                </div>
            </div>
        </Layout>
